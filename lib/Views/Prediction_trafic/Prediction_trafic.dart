...
class TrafficPredictionScreen extends StatefulWidget {
  @override
  _TrafficPredictionScreenState createState() => _TrafficPredictionScreenState();
}
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Expanded(
              child: Text(
                _dateController.text.isEmpty ? "Sélectionner une date" : _dateController.text,
                style: TextStyle(
                  color: _dateController.text.isEmpty ? Colors.grey[500] : Color(0xFF333333),
                  fontSize: 16,
                ),
              ),
            ),
  ...
  Widget _buildBottomNavigation() {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          _buildNavItem(Icons.navigation, "Naviguer", false),
          _buildNavItem(Icons.directions_car, "Itinéraire", false),
          _buildNavItem(Icons.medical_services, "Indications", false),
          _buildNavItem(Icons.schedule, "Prédiction", true),
        ],
      ),
    );
  }
  ...
  void _predictTraffic() {
    if (kIsWeb) {
      ...
      setState(() {
        ...
        List<String> trafficLevels = ["Faible", "Modéré", "Dense", "Très dense"];
...
class TrafficMapPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(Offset(size.width * 0.3, size.height * 0.4), 4, pointPaint);
    canvas.drawCircle(Offset(size.width * 0.7, size.height * 0.6), 4, pointPaint);
    canvas.drawCircle(Offset(size.width * 0.5, size.height * 0.7), 4, pointPaint);
  }
